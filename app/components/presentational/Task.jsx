  ...
  return (
    <TaskItem onClick={() => toggle(task.id)}>
      ...
      <TaskItemInfo>
        ...
        <small style={{ color: '#6E685C', paddingBottom: '0.4em' }}>{`${distance.toLocaleString('us')} Meter${distance > 1 ? 's' : ''} ● ${Math.floor(task.coordinate.accuracy).toLocaleString('us')}`}</small>
